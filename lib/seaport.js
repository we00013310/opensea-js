...
var OpenSeaPort = /** @class */ (function () {
    ...
    function OpenSeaPort(provider, apiConfig, logger) {
        ...
        var generateUrl = function () {
            switch (_this._networkName) {
                case types_1.Network.Main:
                    return constants_1.MAINNET_PROVIDER_URL;
                case types_1.Network.Testnet:
                    return constants_1.TESTNET_PROVIDER_URL;
                case types_1.Network.Ropsten:
                    return constants_1.ROPSTEN_PROVIDER_URL;
                case types_1.Network.Ethereum:
                    return constants_1.ETHEREUM_PROVIDER_URL;
                default:
                    return constants_1.RINKEBY_PROVIDER_URL;
            }
        };
        var readonlyProvider = new Web3.providers.HttpProvider(generateUrl());
    ...
    OpenSeaPort.prototype.createBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var order, hashedOrder, signature, error_2, orderWithSignature, messageHash;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        paymentTokenAddress =
                    ...
                    case 6:
                        orderWithSignature = __assign({}, hashedOrder, signature);
                        return [4 /*yield*/, this.getOrderMessageHash(orderWithSignature)];
                    case 7:
                        messageHash = _d.sent();
                        return [2 /*return*/, __assign({}, orderWithSignature, { 
                                // @ts-ignore
    ...
    OpenSeaPort.prototype.createSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var order, hashedOrder, signature, error_3, orderWithSignature, messageHash;
    ...
    OpenSeaPort.prototype.createSellOrderWithoutSign = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.quantity, quantity = _b === void 0 ? 1 : _b, listingTime = _a.listingTime, _c = _a.expirationTime, expirationTime = _c === void 0 ? 0 : _c, _d = _a.waitForHighestBid, waitForHighestBid = _d === void 0 ? false : _d, englishAuctionReservePrice = _a.englishAuctionReservePrice, paymentTokenAddress = _a.paymentTokenAddress, _e = _a.extraBountyBasisPoints, extraBountyBasisPoints = _e === void 0 ? 0 : _e, buyerAddress = _a.buyerAddress;
        return __awaiter(this, void 0, void 0, function () {
            var order, hashedOrder;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, this._makeSellOrder({
                            asset: asset,
    ...
    OpenSeaPort.prototype.createFactorySellOrders = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var dummyOrder, _makeAndPostOneSellOrder, range, batches, numOrdersCreated, results, _i, batches_1, subRange, batchOrdersCreated;
            var _this = this;
            return __generator(this, function (_g) {
                switch (_g.label) {
                        ...
                        _makeAndPostOneSellOrder = function (asset) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 5:
                                        orderWithSignature = __assign({}, hashedOrder, signature);
                                        return [2 /*return*/, orderWithSignature];
                                }
                            });
                        }); };
                    ...
                    case 4:
                        ...
                        results = results.concat(batchOrdersCreated);
     ...
     * @returns The number of orders created in total
     */
    OpenSeaPort.prototype.createFactorySellOrdersWithoutSign = function (_a) {
        var assets = _a.assets, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.quantity, quantity = _b === void 0 ? 1 : _b, listingTime = _a.listingTime, _c = _a.expirationTime, expirationTime = _c === void 0 ? 0 : _c, _d = _a.waitForHighestBid, waitForHighestBid = _d === void 0 ? false : _d, paymentTokenAddress = _a.paymentTokenAddress, _e = _a.extraBountyBasisPoints, extraBountyBasisPoints = _e === void 0 ? 0 : _e, buyerAddress = _a.buyerAddress, buyerEmail = _a.buyerEmail, _f = _a.numberOfOrders, numberOfOrders = _f === void 0 ? 1 : _f;
        return __awaiter(this, void 0, void 0, function () {
            var dummyOrder, _makeAndPostOneSellOrder, range, batches, numOrdersCreated, results, _i, batches_2, subRange, batchOrdersCreated;
            var _this = this;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                    ...
                    case 2:
                        _g.sent();
                        _makeAndPostOneSellOrder = function (asset) { return __awaiter(_this, void 0, void 0, function () {
                            var order, hashedOrder, orderWithSignature;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this._makeSellOrder({
                                            asset: asset,
                                    ...
                                    case 1:
                                        order = _a.sent();
                                        hashedOrder = __assign({}, order, { hash: utils_1.getOrderHash(order) });
                                        orderWithSignature = __assign({}, hashedOrder);
                                        return [2 /*return*/, orderWithSignature];
                                }
                            });
                        }); };
                        ...
                        _g.label = 3;
                    case 3:
                        if (!(_i < batches_2.length)) return [3 /*break*/, 7];
                        subRange = batches_2[_i];
                        return [4 /*yield*/, Promise.all(subRange.map(function (assetOrderIndex) { return __awaiter(_this, void 0, void 0, function () {
                                var assetIndex;
                                return __generator(this, function (_a) {
                                    assetIndex = Math.floor(assetOrderIndex / numberOfOrders);
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.cancelOrder_.sendTransactionAsync([
                                ...
                                order.salt,
                            ], order.feeMethod, order.side, order.saleKind, order.howToCall, order.calldata, order.replacementPattern, order.staticExtradata, order.v || 0, order.r || constants_1.NULL_BLOCK_HASH, order.s || constants_1.NULL_BLOCK_HASH, { from: accountAddress, gasPrice: gasPrice })];
                    case 2:
     ...
     * @returns The order as stored by the orderbook
     */
    OpenSeaPort.prototype.getOrderMessageHash = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var hash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.hashToSign_.callAsync([
                            order.exchange,
                            order.maker,
                            order.taker,
                            order.feeRecipient,
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        quantityBN = wyvern_js_1.WyvernProtocol.toBaseUnitAmount(utils_1.makeBigNumber(quantity), asset.decimals || 0);
                        wyAsset = utils_1.getWyvernAsset(schema, asset, quantityBN);
                        openSeaAsset = utils_1.assetFromJSON(utils_1.createFakeAsset(asset));
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.approveOrder_.sendTransactionAsync([
                                ...
                                order.expirationTime,
                                order.salt,
                            ], order.feeMethod, order.side, order.saleKind, order.howToCall, order.calldata, order.replacementPattern, order.staticExtradata, includeInOrderBook, { from: accountAddress, gasPrice: gasPrice })];
                    case 2:
                        transactionHash = _a.sent();
    ...
    OpenSeaPort.prototype._getPriceParameters = function (orderSide, tokenAddress, expirationTime, startAmount, endAmount, waitingForBestCounterOrder, englishAuctionReservePrice) {
        if (waitingForBestCounterOrder === void 0) { waitingForBestCounterOrder = false; }
        return __awaiter(this, void 0, void 0, function () {
            var priceDiff, paymentToken, isEther, token, basePrice, extra, reservePrice;
            return __generator(this, function (_a) {
                ...
                switch (paymentToken) {
                    case "0x0000000000000000000000000000000000000000":
                        ...
                        break;
                    case constants_1.USDT_ADDRESS:
                        token = {
                            address: constants_1.USDT_ADDRESS,
                            decimals: 18,
                            eth_price: 0,
                            id: 2,
                        ...
                        break;
                    case constants_1.MGT_ADDRESS_TESTNET:
                        token = {
                            address: constants_1.USDT_ADDRESS,
                            decimals: 18,
                            eth_price: 0,
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 11:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"" + error_13.message.substr(0, debugging_1.MAX_ERROR_LENGTH) + "...\"");
                    case 12:
