...
var OpenSeaPort = /** @class */ (function () {
    ...
    function OpenSeaPort(provider, apiConfig, logger) {
        ...
        var readonlyProvider = new Web3.providers.HttpProvider(this._networkName == types_1.Network.Main
            ? constants_1.MAINNET_PROVIDER_URL
            : types_1.Network.Testnet
                ? constants_1.TESTNET_PROVIDER_URL
                : constants_1.RINKEBY_PROVIDER_URL);
        // Web3 Config
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 7:
                        messageHash = _d.sent();
                        return [2 /*return*/, __assign(__assign({}, orderWithSignature), { 
                                //@ts-ignore
    ...
    OpenSeaPort.prototype.fulfillOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var matchingOrder, _b, buy, sell, metadata, transactionHash, err_1;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (!order.messageHash) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.api.pendingOrder(order.messageHash)];
                    case 3:
                        _c.sent();
                        _c.label = 4;
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this._confirmTransaction(transactionHash, types_1.EventType.MatchOrders, "Fulfilling order", function () { return __awaiter(_this, void 0, void 0, function () {
                            var isOpen;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        gasEstimate = _a.sent();
                        return [4 /*yield*/, this._wyvernProtocol.wyvernProxyRegistry.registerProxy.sendTransactionAsync(__assign(__assign({}, txnData), { gasPrice: gasPrice, gas: this._correctGasAmount(gasEstimate) }))];
                    case 3:
    ...
    OpenSeaPort.prototype._getSchema = function (schemaName) {
        ...
        // @ts-ignore
        var schema = WyvernSchemas.schemas[this._networkName].filter(
        // @ts-ignore
        function (s) { return s.name == schemaName_; })[0];
        if (!schema) {
