...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.createSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var order, hashedOrder, signature, error_3, orderWithSignature, ahihi;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 6:
                        orderWithSignature = __assign(__assign({}, hashedOrder), signature);
                        return [4 /*yield*/, this.getOrderHashAhihi(orderWithSignature)];
                    case 7:
                        ahihi = _f.sent();
     ...
     * @returns The order as stored by the orderbook
     */
    OpenSeaPort.prototype.getOrderHashAhihi = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var hash;
            return __generator(this, function (_a) {
                switch (_a.label) {
